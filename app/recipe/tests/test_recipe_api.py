...
class PublicRecipeAPITests(TestCase):
    """Tests unauthenticated API requests to the recipe API."""
...
class PrivateRecipeAPITests(TestCase):
    """Tests authenticated API requests to the recipe API."""
    ...
    def test_create_recipe_with_new_tags(self):
        """Tests creating a recipe with a new tags."""
        payload = {
    ...
    def test_create_tag_on_update(self):
        """Tests create tags when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Curry and meat')
        tag1 = Tag.objects.create(user=self.user, name='Vegan')
        tag2 = Tag.objects.create(user=self.user, name='Meat lover')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as img_file:
            ...
            img_file.seek(0)  # Moves file pointer back to file beginning
